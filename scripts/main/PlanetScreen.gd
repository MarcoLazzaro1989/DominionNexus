...
# Header
@onready var stone_label    : Label = $TopBar/HBoxContainer/Resources/StoneLabel
@onready var wood_label     : Label = $TopBar/HBoxContainer/Resources/WoodLabel
@onready var velarite_label : Label = $TopBar/HBoxContainer/Resources/VelariteLabel
@onready var biome_label    : Label = $TopBar/HBoxContainer/Resources/BiomeLabel
...
func show_level_up_popup(level: int):
	$MainTabs/AvatarTab/AnimAvatar.play("LevelUpFlash")
